...
import { HardwareShopCartItemComponent } from './windows/hardware-shop/hardware-shop-cart-item/hardware-shop-cart-item.component';
...
import { HardwareShopItemListComponent } from './windows/hardware-shop/hardware-shop-item-list/hardware-shop-item-list.component';
import { HardwareShopComponent } from './windows/hardware-shop/hardware-shop.component';
import { HardwareShopSidebarItemComponent } from './windows/hardware-shop/hardware-shop-sidebar-item/hardware-shop-sidebar-item.component';
...
import { WalletAppTransactionComponent } from './windows/wallet-app/wallet-app-transaction/wallet-app-transaction.component';
import { HardwareShopSidebarComponent } from './windows/hardware-shop/hardware-shop-sidebar/hardware-shop-sidebar.component';
...
@NgModule({
  ...
  imports: [CommonModule, DesktopRoutingModule, ReactiveFormsModule, ContextMenuModule, FormsModule, PxToModule],
})
