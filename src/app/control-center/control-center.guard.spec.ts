...
describe('ControlCenterGuard', () => {
  ...
  it('should try to login and allow activation if it succeeded', inject(
    [ControlCenterGuard, WebsocketService, Router],
    (guard: ControlCenterGuard, webSocket: WebsocketService, router: Router) => {
  ...
  it('should try to login and navigate back to login if it failed', inject(
    [ControlCenterGuard, WebsocketService, Router],
    (guard: ControlCenterGuard, webSocket: WebsocketService, router: Router) => {
