...
describe('WebsocketService', () => {
  ...
  it('#refreshAccountInfo() should get information about the account, save it and return it', inject(
    [WebsocketService],
  ...
  it('#trySession() should return true if the user is already logged in', inject(
    [WebsocketService],
    (service: WebsocketService) => {
  ...
  it('#trySession() should return false if the user is not logged in and there is no token in the localstorage', inject(
    [WebsocketService],
    (service: WebsocketService) => {
      spyOn(service, 'request');
  ...
  it('#trySession() should refresh the account information and return true if the authentication using the token in the localstorage succeeded', inject(
    [WebsocketService],
    (service: WebsocketService) => {
  ...
  it('#trySession() should remove the token from the localstorage if the authentication failed', inject(
    [WebsocketService],
    (service: WebsocketService) => {
