...
describe('FileService', () => {
  ...
  beforeEach(() => {
    ...
    TestBed.configureTestingModule({
      providers: [{ provide: WebsocketService, useValue: webSocket }],
    });
  });
  ...
  it('#getFiles() should make a request to device/file/all and return files of the response', inject(
    [FileService],
    (service: FileService) => {
  ...
  it('#getFiles() should use Path.ROOT as default if parentUUID is not specified', inject(
    [FileService],
    (service: FileService) => {
  ...
  it('#getFilesRecursively() should go through all folders and return all the files and folders recursively', inject(
    [FileService],
    (service: FileService) => {
  ...
  it('#getFilesRecursively() should not go inside a file like a folder', inject(
    [FileService],
    (service: FileService) => {
      spyOn(service, 'getFiles').and.callFake(getTestFiles);
  ...
  it('#getFilesRecursively() should only look inside one folder recursively if parentUUID is given', inject(
    [FileService],
    (service: FileService) => {
      spyOn(service, 'getFiles').and.callFake(getTestFiles);
  ...
  it('#getFile() should make a request to device/file/info and return the response', inject(
    [FileService],
    (service: FileService) => {
  ...
  it('#getRootFile() should return an empty dummy directory with the right device UUID', inject(
    [FileService],
    (service: FileService) => {
  ...
  it('#getFile() should return the root file from getRootFile() if the UUID is Path.ROOT', inject(
    [FileService],
    (service: FileService) => {
  ...
  it('#move() should make a request to device/file/move and return the response', inject(
    [FileService],
    (service: FileService) => {
  ...
  it('#changeFileContent() should make a request to device/file/update and return the response', inject(
    [FileService],
    (service: FileService) => {
  ...
  it('#deleteFile() should make a request to device/file/delete and return the response', inject(
    [FileService],
    (service: FileService) => {
      const data = { a: 'b', c: 'd', e: 'f', ghi: 'jkl' } as any;
      webSocket.ms.and.returnValue(rxjs.of(data));
  ...
  it('#createFile() should make a request to device/file/create with is_directory set to false and return the response', inject(
    [FileService],
    (service: FileService) => {
  ...
  it('#createFile() should use Path.ROOT as default if parentUUID is not specified and an empty string as default for the file content', inject(
    [FileService],
    (service: FileService) => {
  ...
  it('#createDirectory() should make a request to device/file/create with is_directory set to true and content set empty and return the response', inject(
    [FileService],
    (service: FileService) => {
  ...
  it('#createDirectoy() should use Path.ROOT as default if parentUUID is not specified', inject(
    [FileService],
    (service: FileService) => {
      const fileName = 'example_file_name';
  ...
  it('#getAbsolutePath() should return an empty list if the path is already the root', inject(
    [FileService],
    (service: FileService) => {
  ...
  it('#getAbsolutePath() should return the absolute path of a file as an array of directory and file name strings', inject(
    [FileService],
    (service: FileService) => {
  ...
  it('#getFromPath() should throw a "file_not_found" error if the path is empty', inject(
    [FileService],
    (service: FileService) => {
  ...
  it('#getFromPath() should return the parentUUID file if the remaining path is just "."', inject(
    [FileService],
    (service: FileService) => {
  ...
  it('#getFromPath() should continue with the next part of the path if the current is "."', inject(
    [FileService],
    (service: FileService) => {
      spyOn(service, 'getFiles').and.callFake(getTestFiles);
  ...
  it('#getFromPath() should continue with the parent of parentUUID if the current path part is ".."', inject(
    [FileService],
    (service: FileService) => {
      spyOn(service, 'getFile').and.callFake(getTestFile);
      spyOn(service, 'getFiles').and.callFake(getTestFiles);
  ...
  it('#getFromPath() should go through the path and return the matching file/directory from #getFiles() of the last name if there is one', inject(
    [FileService],
    (service: FileService) => {
      // - 0 (file)
      // - 1 (dir)
      ...
      expect(successes).withContext('A getFromPath test case threw an error or did not return anything').toEqual(4);
    }
  ));

  it('#getFromPath() should throw a "file_not_found" error if a part of the path except the last is no directory', inject(
    [FileService],
    (service: FileService) => {
      // - 0 (file)
      // - 1 (dir)
  ...
  it('#getFromPath() should throw a "file_not_found" error if a part of the path does not exist', inject(
    [FileService],
    (service: FileService) => {
      // - 0 (file)
      // - 1 (dir)
  ...
  it('#getFromPath() should use Path.ROOT as default if parentUUID is not specified', inject(
    [FileService],
    (service: FileService) => {
  ...
  it('#moveToPath() should throw a "destination_is_file" error if the destination path is not a directory', inject(
    [FileService],
    (service: FileService) => {
  ...
  it('#moveToPath() should throw a "file_already_exists" error if a file with the same name already exists', inject(
    [FileService],
    (service: FileService) => {
      const dest: File = {
        content: '',
  ...
  it('#moveToPath() should call #move() with the right parameters if the destination is valid', inject(
    [FileService],
    (service: FileService) => {
      const dest: File = {
        content: '',
  ...
  it('#rename() should call (and return the result of) #move() with the right parameters', inject(
    [FileService],
    (service: FileService) => {
  ...
  it('#copyFile() should throw an error if the destination file already exists', inject(
    [FileService],
    (service: FileService) => {
      spyOn(service, 'getFile').and.callFake(getTestFile);
      spyOn(service, 'getFiles').and.callFake(getTestFiles);
  ...
  it('#copyFile() should copy the source file to the destination using the same name if the destination is a folder', inject(
    [FileService],
    (service: FileService) => {
      spyOn(service, 'getFile').and.callFake(getTestFile);
      spyOn(service, 'getFiles').and.callFake(getTestFiles);
  ...
  it('#copyFile() should throw an error if the path and the path minus the last part (the parent) do not exist', inject(
    [FileService],
    (service: FileService) => {
      spyOn(service, 'getFile').and.callFake(getTestFile);
      spyOn(service, 'getFiles').and.callFake(getTestFiles);
  ...
  it('#copyFile() should throw an error if the path minus the last part (the parent) is not a directory', inject(
    [FileService],
    (service: FileService) => {
      spyOn(service, 'getFile').and.callFake(getTestFile);
      spyOn(service, 'getFiles').and.callFake(getTestFiles);
  ...
  it(
    '#copyFile() should throw an error if the destination folder already contains a file ' +
  ...
  it(
    '#copyFile() should copy the source file to the destination folder (path minus last part) ' +
    ...
    inject([FileService], (service: FileService) => {
      ...
      service.copyFile(testFiles[5], new Path(['1', '2', 'abc'])).subscribe(
        (file) => {
          expect(service.createFile).toHaveBeenCalledWith(
            testFiles[5].device,
            'abc',
  ...
  it('#copyFile() should take the parentUUID of the path as the destination folder if the path contains 0 or 1 part', inject(
    [FileService],
    (service: FileService) => {
      spyOn(service, 'getFile').and.callFake(getTestFile);
      spyOn(service, 'getFiles').and.callFake(getTestFiles);
  ...
  it('#copyFile() should redirect error messages other than file_not_found from getFromPath()', inject(
    [FileService],
    (service: FileService) => {
