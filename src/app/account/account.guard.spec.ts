...
describe('AccountGuard', () => {
  ...
  it('should try to login and navigate back to / if it succeeded',
    inject([AccountGuard, WebsocketService, Router], (guard: AccountGuard, webSocket: WebsocketService, router: Router) => {
  ...
  it('should try to login and allow activation if it failed',
    inject([AccountGuard, WebsocketService, Router], (guard: AccountGuard, webSocket: WebsocketService, router: Router) => {
